...
import me.flashyreese.mods.sodiumextra.Sodium1201ExtraMod;
...
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT, modid = Sodium1201ExtraMod.MOD_ID)
